...
(function($) {
    ...
    BootstrapTable.prototype.initHeader = function() {
        ...
        this.$container.off("click", ".th-inner").on("click",
            ".th-inner",
            function(event) {
                var target = $(this);
    ...
    BootstrapTable.prototype.initToolbar = function() {
        ...
        html = [
            sprintf('<div class="columns columns-%s btn-group pull-%s">',
        ...
        if (this.options.showColumns) {
            ...
            $keepOpen.find("li").off("click").on("click",
                function(event) {
                    event.stopImmediatePropagation();
                });
            $keepOpen.find("input").off("click").on("click",
                function() {
                    var $this = $(this);
    ...
    BootstrapTable.prototype.initSearch = function() {
        ...
        if (this.options.sidePagination !== "server") {
            ...
            var s = this.searchText &&
                (this.options.escape ? escapeHTML(this.searchText) : this.searchText).toLowerCase();
            var f = $.isEmptyObject(this.filterColumns) ? null : this.filterColumns;

            // Check filter
            this.data = f
                ? $.grep(this.options.data,
                    function(item, i) {
                        for (var key in f) {
                ...
                if (column.checkbox || column.radio) {
                    ...
                    text = that.options.cardView
                        ? [
                            ...
                            ? sprintf('<span class="title" %s>%s</span>',
                                style,
            ...
            function() {
                ...
                if ($tr.next().is("tr.detail-view")) {
                    $this.find("i").attr("class",
                        sprintf("%s %s", that.options.iconsPrefix, that.options.icons.detailOpen));
                    that.trigger("collapse-row", index, row);
                    $tr.next().remove();
                } else {
                    $this.find("i").attr("class",
                        sprintf("%s %s", that.options.iconsPrefix, that.options.icons.detailClose));
