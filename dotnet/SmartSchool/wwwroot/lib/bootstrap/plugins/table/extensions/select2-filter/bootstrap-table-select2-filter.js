        ...
        $.each(that.columns,
            function(i, column) {
                ...
                if (!column.filter) {
                    ...
                    case "input":
                        html.push('<input type="text" data-filter-field="' +
                            column.field +
            ...
            function(idx, column) {
                if (column.filter && column.filter.type === "select") {
                    ...
                    if ($selectEle.length > 0 && !$selectEle.data().select2) {
                        ...
                        $selectEle.on("select2:unselecting",
                            function(event) {
