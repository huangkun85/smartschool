...
(function($) {
    ...
    var initCookieFilters = function(bootstrapTable) {
        setTimeout(function() {
                var parsedCookieFilters = JSON.parse(getCookie(bootstrapTable,
                    bootstrapTable.options.cookieIdTable,
    ...
    BootstrapTable.prototype.init = function() {
        ...
        if (this.options.filterControl) {
            var that = this;
            this.$el.on("column-search.bs.table",
                function(e, field, text) {
                    var isNewField = true;
    ...
    BootstrapTable.prototype.initServer = function() {
        var bootstrapTable = this,
            ...
            cookiesPresent = function() {
                var cookie = JSON.parse(getCookie(bootstrapTable,
                    bootstrapTable.options.cookieIdTable,
                    cookieIds.filterControl));
                return bootstrapTable.options.cookie && cookie;
            };

        selectsWithoutDefaults = $.grep(bootstrapTable.columns,
            function(column) {
    ...
    BootstrapTable.prototype.initCookie = function() {
        ...
        //pageSize
        this.options.pageSize = pageListCookie
            ? pageListCookie === this.options.formatAllRows()
            ? pageListCookie
            : +pageListCookie
